...
## Routeplanner [/reisadvies/routes/{startPoint}/{endPoint}/{startX}/{startY}/{endX}/{endY}/{date}/{time}/{arrivalDeparture}/{byBus}/{byTram}/{byMetro}/{byTrain}/{byBelbus}/{language}]
...
+ Parameters
    ...
    + date       (required, string, `09-05-2015`) ... Datum van het vertrek/aankomen.
    + time       (required, string, `14:00`) ... Tijd van het vertrek/aankomen.
...
## Lijn informatie [/lijnen/titel/{entiteit_nummer}/{lijnnummer_intern}/{richtingcode}]
...
## Doorkomsten op dit moment [/dienstregeling/halteVolgorde/{entiteit_nummer}/{lijnnummer_intern}/{richtingcode}/{date}/{language}]
...
+ Parameters
    ...
    + lijnnummer_intern (required, number, `10`)
    + richtingcode      (required, number, `7`)
    + date              (required, string, `11-05-2015`)
    + language          (required, string, `nl`)

+ Response 200 (application/json)

## Dienstregeling [/dienstregeling/dienstregeling/{entiteit_nummer}/{lijnnummer_intern}/{richtingcode}/{date}/false/{language}]
...
## Omleidingen [/reizigersberichten/omleidingen/lijn/{entiteit_nummer}/{lijnnummer_intern}/{richtingcode}/{date}/{language}]
